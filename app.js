...
const SECTIONS_DATA = {"0 Generell": {"": [{"id": "GEN-00-1", "name": "Pris for tilbudsfase"}, {"id": "GEN-00-2", "name": "Fremdriftsplan i tilbudsfase"}, {"id": "GEN-00-4", "name": "Fremdriftsplan"}, {"id": "GEN-00-5", "name": "Pris for prosjektering"}, {"id": "GEN-00-6", "name": "Søknader-liste"}, {"id": "GEN-00-7", "name": "CV for nøkkelpersonell"}, {"id": "", "name": "Prosjekteringsmøter KON+Tunnel"}, {"id": "", "name": "Supplementerne grunnundersøkelser"}]}, "1 Tunneler": {"Konsept og Optimalisering": [{"id": "FAG-02-11", "name": "1. Tunneltverrsnitt T9,5\nVurdere om T9,5 kan være en aktuell løsning, og hvilke konsekvenser dette har for krav, tekniske installasjoner, skilt, elektro, ventilasjon, drift og vedlikehold. Definere utforming tverrsnitt i henhold til krav etter N500 og konkurransegrunnlaget"}, {"id": "FAG-02-13", "name": "2. Utforming av vegoppbygging i tunnel\n\nDimensjonering av vegoppbygging i tunnel\n\nVurdere utforming traubunn etter krav i håndbok eller flukte med bunn VA grøft.\n\nJVIS må vurdere hvilke løsning som velges etter å ha sett på fordeler og ulemper med de to løsningene."}, {"id": "FAG-02-14", "name": "3. Plassering og utforming infrastruktur for elektrisk anlegg i samarbeid med Rasmussen og Strand\nPlassering av trekkerør, kummer, i bankett eller bak veggelement.\nJVIS har erfaring med plassering av trekkerør bak veggelementer-fra E39 Lyngdal. Betyr at vegger må sprenges rette for å gi plass til trekkerør.\n\nHva er best kost/nytte\n\nJVIS må vurdere hvilke løsning som velges etter å ha sett på fordeler og ulemper med de to løsningene."}, {"id": "FAG-02-21", "name": "4. Bergsikring\nGjennomgang av fordeling sikringsklasser etter geologisk rapport.\n\nMengder gjøres opp etter regulerbare mengder per sikringsklasse og kontrollere om  Nye Veiers sin fordeling stemmer mot geologisk rapport."}, {"id": "FAG-02-23", "name": "5. Injeksjon\nVurdere forventet injeksjonsomfang og injeksjonsmengder opp mot krav i D1.1 tabell 2.2, inkludert mulighet for differensiert injeksjonsstrategi. Gjennomgang forventing av injeksjon etter geologisk rapport.\n\nStemmer forventete mengder i geologisk rapport mot byggherrens mengder\n\nUtforming av injeksjonsskjerm.\n\nForventete mengder per skjerm"}, {"id": "FAG-02-24", "name": "6. Havarinisjer og tekniske bygg\nVurdere plassering av havarinisjer i sammenheng med tekniske bygg, og om dette kan gi redusert omfang eller bedre samordning av funksjoner."}, {"id": "FAG-02-25", "name": "7. Portaler\nVurdere om traktform/utvidelse kan etableres inne i tunnel i stedet for i portalkonstruksjonen."}, {"id": "FAG-02-31", "name": "8. Rensebasseng/vaskevannsbasseng\nVurdere om rensebasseng kan flyttes fra siste havarinisje i vestgående løp til plassering utenfor tunnel, inkludert konsekvenser for VA, drift, adkomst, areal og miljø."}, {"id": "FAG-02-33", "name": "9. Skiltplan og elektro\nGjennomgå skiltplan i tunnel og vurdere grensesnitt mot elektro, føringsveier, tekniske bygg, belysning, ventilasjon og nødutstyr."}, {"id": "FAG-02-41", "name": "10. Tverrfaglig koordinering\nGjennomføre nødvendig koordinering med relevante fagområder, eksempelvis veg, tunnel, geologi, elektro, VA/drenering, anleggsgjennomføring og kost."}, {"id": "FAG-02-42", "name": "11. Sluttnotat med anbefalinger\nUtarbeide et kort optimaliseringsnotat med funn, vurderte tiltak, risiko, gevinstpotensial og anbefalt videre prosess."}, {"id": "FAG-02-43", "name": "12. IFC fill"}, {"id": "FAG-02-44", "name": "13. Tegninger\nSkiltplan\nKomplett tverrsnitt (inkl. alle fag) profil hovedløp, havarinisjer, tverrforbindelser og nisjer for tekniske rom"}, {"id": "", "name": "14. Intern kvalitetssikring\nSidemannskontroll/seniorgjennomgang av vurderinger og leveranse før oversendelse."}, {"id": "FAG-02-44", "name": "16. Skiltplan + mengder i tunnel"}]}, "2 Konstruksjoner/bruer": {"K400 Audnedalen bru": [{"id": "FAG-05-11", "name": "1. Grunnlagsgjennomgang og avklaringer"}, {"id": "FAG-05-21", "name": "2. Geoteknisk vurdering av fundamenteringsforhold i FFB-akser"}, {"id": "FAG-05-31", "name": "3. Vurdering av fundamenteringsprinsipp og konsekvens for kostnad/byggbarhet"}, {"id": "FAG-05-41", "name": "4. Optimalisering av akseinndeling, inkludert vurdering av fjerning av akse 2"}, {"id": "FAG-05-51", "name": "5. Vurdering av spennfordeling, eksempelvis 136 + 236 + 136 m"}, {"id": "FAG-05-61", "name": "6. Vurdering av flytting av landkar og konsekvens for fylling"}, {"id": "FAG-05-71", "name": "7. Vurdering av mer kostnadseffektiv søyleform"}, {"id": "FAG-05-81", "name": "8. Vurdering av behov for avstivning i byggefase"}, {"id": "FAG-05-111", "name": "9. Mengder spennarmering, antall og type av lager"}, {"id": "FAG-05-112", "name": "10. Beslutningsnotat"}, {"id": "FAG-05-113", "name": "11. Modell i IFC format"}], "K300 Grundelandsvatnet bru": [{"id": "FAG-06-11", "name": "1. Optimalisering av spennfordeling – ett spenn bru, med ståljekle med betongdekke i overbygning"}, {"id": "FAG-06-12", "name": "2. Vurdering av fundamentering og underbygning"}, {"id": "FAG-06-21", "name": "3. Antall og type av lager"}, {"id": "FAG-06-31", "name": "4. Beslutningsnotat"}, {"id": "FAG-06-41", "name": "5. Modell i IFC format"}], "K500 Faksevatnet bru": [{"id": "", "name": "1. Optimalisering av spennfordeling – ett spenn bru, med ståljekle med betongdekke i overbygning"}, {"id": "", "name": "2. Vurdering av fundamentering og underbygning"}, {"id": "", "name": "3. Antall og type av lager"}, {"id": "", "name": "4. Beslutningsnotat"}, {"id": "", "name": "5. Modell i IFC format"}], "K700 Optedal bru": [{"id": "", "name": "1. Optimalisering overbygning – stålbjelke med betongdekke skal vurderes"}, {"id": "", "name": "2. Vurdering av forkorting av midtspenn til ca. 40 m"}, {"id": "", "name": "3. Vurdering av fundamentering og underbygning"}, {"id": "", "name": "4. Antall og type av lager"}, {"id": "", "name": "5. Beslutningsnotat"}, {"id": "", "name": "6. Modell i IFC format"}], "K600 Lene bruer": [{"id": "", "name": "1. Vurdering av stålbjelkealternativ for begge bruene"}, {"id": "", "name": "2. Vurdering av løsning uten søyle i akse 2 i østgående bru"}, {"id": "", "name": "3. Vurdering av forlengelse av vestgående bru"}, {"id": "", "name": "4. Vurdering av reduksjon av murer"}, {"id": "", "name": "5. Antall og type av lager"}, {"id": "", "name": "6. Beslutningsnotat"}, {"id": "", "name": "7. Modell i IFC format"}], "Alle brukonstruksjoner": [{"id": "", "name": "Generell vurdering av peler – alle konstruksjoner"}, {"id": "", "name": "Forslag til optimalisering av Høylandsbekken bru (K540)-skisse"}, {"id": "", "name": "Optimalisering av kulverter og faunapasassjer som er effekt av optimalisering av veilinja må avklares nærmere med INO-Prosjekteringsleder"}, {"id": "", "name": "Vurdering"}]}, "3 YM": {"": [{"id": "", "name": "Ny oppgave"}]}};
// Full seed for the base order list, generated from the source Excel
// (Bestillingsliste – Anbudsfase Totalentreprise, 2026-07-01).
const SEED_TASKS = [{"excelId": "GEN-00-1", "section": "0 Generell", "undersec": "", "sub": "", "name": "Pris for tilbudsfase", "selected": true, "frist": "", "timer": "0", "status": "Ikke startet", "link": "", "comment": "Iht samarbeidsavtale dette konsulet dekker selv", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "GEN-00-2", "section": "0 Generell", "undersec": "", "sub": "", "name": "Fremdriftsplan i tilbudsfase", "selected": true, "frist": "2026-08-06", "timer": "8", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "GEN-00-4", "section": "0 Generell", "undersec": "", "sub": "", "name": "Fremdriftsplan", "selected": true, "frist": "2026-09-20", "timer": "40", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "GEN-00-5", "section": "0 Generell", "undersec": "", "sub": "", "name": "Pris for prosjektering", "selected": true, "frist": "2026-10-04", "timer": "0", "status": "Ikke startet", "link": "", "comment": "Iht samarbeidsavtale dette konsulet dekker selv", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "GEN-00-6", "section": "0 Generell", "undersec": "", "sub": "", "name": "Søknader-liste", "selected": true, "frist": "2026-10-04", "timer": "8", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "GEN-00-7", "section": "0 Generell", "undersec": "", "sub": "", "name": "CV for nøkkelpersonell", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "avklares", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-11", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "1. Tunneltverrsnitt T9,5\nVurdere om T9,5 kan være en aktuell løsning, og hvilke konsekvenser dette har for krav, tekniske installasjoner, skilt, elektro, ventilasjon, drift og vedlikehold. Definere utforming tverrsnitt i henhold til krav etter N500 og konkurransegrunnlaget", "selected": true, "frist": "2026-08-03", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-13", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "2. Utforming av vegoppbygging i tunnel\n\nDimensjonering av vegoppbygging i tunnel\n\nVurdere utforming traubunn etter krav i håndbok eller flukte med bunn VA grøft.\n\nJVIS må vurdere hvilke løsning som velges etter å ha sett på fordeler og ulemper med de to løsningene.", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-14", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "3. Plassering og utforming infrastruktur for elektrisk anlegg i samarbeid med Rasmussen og Strand\nPlassering av trekkerør, kummer, i bankett eller bak veggelement.\nJVIS har erfaring med plassering av trekkerør bak veggelementer-fra E39 Lyngdal. Betyr at vegger må sprenges rette for å gi plass til trekkerør.\n\nHva er best kost/nytte\n\nJVIS må vurdere hvilke løsning som velges etter å ha sett på fordeler og ulemper med de to løsningene.", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-21", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "4. Bergsikring\nGjennomgang av fordeling sikringsklasser etter geologisk rapport.\n\nMengder gjøres opp etter regulerbare mengder per sikringsklasse og kontrollere om  Nye Veiers sin fordeling stemmer mot geologisk rapport.", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-23", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "5. Injeksjon\nVurdere forventet injeksjonsomfang og injeksjonsmengder opp mot krav i D1.1 tabell 2.2, inkludert mulighet for differensiert injeksjonsstrategi. Gjennomgang forventing av injeksjon etter geologisk rapport.\n\nStemmer forventete mengder i geologisk rapport mot byggherrens mengder\n\nUtforming av injeksjonsskjerm.\n\nForventete mengder per skjerm", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-24", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "6. Havarinisjer og tekniske bygg\nVurdere plassering av havarinisjer i sammenheng med tekniske bygg, og om dette kan gi redusert omfang eller bedre samordning av funksjoner.", "selected": true, "frist": "2026-07-11", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-25", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "7. Portaler\nVurdere om traktform/utvidelse kan etableres inne i tunnel i stedet for i portalkonstruksjonen.", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-31", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "8. Rensebasseng/vaskevannsbasseng\nVurdere om rensebasseng kan flyttes fra siste havarinisje i vestgående løp til plassering utenfor tunnel, inkludert konsekvenser for VA, drift, adkomst, areal og miljø.", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-33", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "9. Skiltplan og elektro\nGjennomgå skiltplan i tunnel og vurdere grensesnitt mot elektro, føringsveier, tekniske bygg, belysning, ventilasjon og nødutstyr.", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-41", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "10. Tverrfaglig koordinering\nGjennomføre nødvendig koordinering med relevante fagområder, eksempelvis veg, tunnel, geologi, elektro, VA/drenering, anleggsgjennomføring og kost.", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-42", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "11. Sluttnotat med anbefalinger\nUtarbeide et kort optimaliseringsnotat med funn, vurderte tiltak, risiko, gevinstpotensial og anbefalt videre prosess.", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-43", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "12. IFC fill", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-44", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "13. Tegninger\nSkiltplan\nKomplett tverrsnitt (inkl. alle fag) profil hovedløp, havarinisjer, tverrforbindelser og nisjer for tekniske rom", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-05-11", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K400 Audnedalen bru", "name": "1. Grunnlagsgjennomgang og avklaringer", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-05-21", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K400 Audnedalen bru", "name": "2. Geoteknisk vurdering av fundamenteringsforhold i FFB-akser", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-05-31", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K400 Audnedalen bru", "name": "3. Vurdering av fundamenteringsprinsipp og konsekvens for kostnad/byggbarhet", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-05-41", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K400 Audnedalen bru", "name": "4. Optimalisering av akseinndeling, inkludert vurdering av fjerning av akse 2", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-05-51", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K400 Audnedalen bru", "name": "5. Vurdering av spennfordeling, eksempelvis 136 + 236 + 136 m", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-05-61", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K400 Audnedalen bru", "name": "6. Vurdering av flytting av landkar og konsekvens for fylling", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-05-71", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K400 Audnedalen bru", "name": "7. Vurdering av mer kostnadseffektiv søyleform", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-05-81", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K400 Audnedalen bru", "name": "8. Vurdering av behov for avstivning i byggefase", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-05-111", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K400 Audnedalen bru", "name": "9. Mengder spennarmering, antall og type av lager", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-05-112", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K400 Audnedalen bru", "name": "10. Beslutningsnotat", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-05-113", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K400 Audnedalen bru", "name": "11. Modell i IFC format", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-06-11", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K300 Grundelandsvatnet bru", "name": "1. Optimalisering av spennfordeling – ett spenn bru, med ståljekle med betongdekke i overbygning", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-06-12", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K300 Grundelandsvatnet bru", "name": "2. Vurdering av fundamentering og underbygning", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-06-21", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K300 Grundelandsvatnet bru", "name": "3. Antall og type av lager", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-06-31", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K300 Grundelandsvatnet bru", "name": "4. Beslutningsnotat", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-06-41", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K300 Grundelandsvatnet bru", "name": "5. Modell i IFC format", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K500 Faksevatnet bru", "name": "1. Optimalisering av spennfordeling – ett spenn bru, med ståljekle med betongdekke i overbygning", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K500 Faksevatnet bru", "name": "2. Vurdering av fundamentering og underbygning", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K500 Faksevatnet bru", "name": "3. Antall og type av lager", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K500 Faksevatnet bru", "name": "4. Beslutningsnotat", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K500 Faksevatnet bru", "name": "5. Modell i IFC format", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K700 Optedal bru", "name": "1. Optimalisering overbygning – stålbjelke med betongdekke skal vurderes", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K700 Optedal bru", "name": "2. Vurdering av forkorting av midtspenn til ca. 40 m", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K700 Optedal bru", "name": "3. Vurdering av fundamentering og underbygning", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K700 Optedal bru", "name": "4. Antall og type av lager", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K700 Optedal bru", "name": "5. Beslutningsnotat", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K700 Optedal bru", "name": "6. Modell i IFC format", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K600 Lene bruer", "name": "1. Vurdering av stålbjelkealternativ for begge bruene", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K600 Lene bruer", "name": "2. Vurdering av løsning uten søyle i akse 2 i østgående bru", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K600 Lene bruer", "name": "3. Vurdering av forlengelse av vestgående bru", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K600 Lene bruer", "name": "4. Vurdering av reduksjon av murer", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K600 Lene bruer", "name": "5. Antall og type av lager", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K600 Lene bruer", "name": "6. Beslutningsnotat", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "K600 Lene bruer", "name": "7. Modell i IFC format", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "Alle brukonstruksjoner", "name": "Generell vurdering av peler – alle konstruksjoner", "selected": true, "frist": "", "timer": "100", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "0 Generell", "undersec": "", "sub": "", "name": "Prosjekteringsmøter KON+Tunnel", "selected": true, "frist": "", "timer": "115", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "3 YM", "undersec": "3.1 Klima", "sub": "", "name": "Ny oppgave", "selected": false, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "Alle brukonstruksjoner", "name": "Forslag til optimalisering av Høylandsbekken bru (K540)-skisse", "selected": true, "frist": "", "timer": "20", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "Alle brukonstruksjoner", "name": "Optimalisering av kulverter og faunapasassjer som er effekt av optimalisering av veilinja må avklares nærmere med INO-Prosjekteringsleder", "selected": true, "frist": "", "timer": "0", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "2 Konstruksjoner/bruer", "undersec": "2.1", "sub": "Alle brukonstruksjoner", "name": "Vurdering", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "0 Generell", "undersec": "", "sub": "", "name": "Supplementerne grunnundersøkelser", "selected": true, "frist": "2026-06-30", "timer": "", "status": "Ferdig", "link": "https://impleniaag.sharepoint.com/:w:/r/teams/INO-E39Blrstad-Lyngdal-ANB-Felles/Shared%20Documents/ANB%20-%20Felles/5%20Arbeidsmappe%20Prosjektering/Leveranser/2026-06-30%20Innspill%20grunnunders%C3%B8kelser/Tilbyders%20forslag%20om%20supplerende%20grunnunders%C3%B8kelser.docx?d=w3a092c6ba14e4c3d84c5fc2a5b6fd158&csf=1&web=1&e=NKgdkH", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "", "section": "1 Tunneler", "undersec": "1.1 Eikeråsheiatunnel", "sub": "Konsept og Optimalisering", "name": "14. Intern kvalitetssikring\nSidemannskontroll/seniorgjennomgang av vurderinger og leveranse før oversendelse.", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}, {"excelId": "FAG-02-44", "section": "1 Tunneler", "undersec": "1.2 Elektro", "sub": "Konsept og Optimalisering", "name": "16. Skiltplan + mengder i tunnel", "selected": true, "frist": "", "timer": "", "status": "Ikke startet", "link": "", "comment": "", "ansvar": "", "eier": "", "fredagstatus": ""}];
...
function initTasks() {
  // Build the base list directly from SEED_TASKS (generated from the source Excel),
  // carrying every column: underkapittel, sub-gruppe, frist, timer, status,
  // valgt, ansvar, kommentar, lenke og fredagstatus.
  Object.keys(SECTIONS_DATA).forEach(function(sec) {
    sectionOpen[sec] = true;
    undersecOpen[sec] = undersecOpen[sec] || {};
  });
  SEED_TASKS.forEach(function(item) {
    tasks.push({
      id: idCounter++, excelId: item.excelId || '',
      section: item.section, undersec: item.undersec || '', sub: item.sub || '',
      name: item.name,
      selected: !!item.selected,
      frist: item.frist || '', timer: item.timer || '',
      status: item.status || 'Ikke startet',
      link: item.link || '', comment: item.comment || '',
      eier: item.eier || '', ansvar: item.ansvar || '',
      fredagstatus: item.fredagstatus || ''
    });
    if (item.undersec) undersecOpen[item.section][item.undersec] = true;
  });
}
...
try {
  if (localStorage.getItem('bl_seed_version') !== SEED_VERSION) {
    _seedReset = true;
    try {
      var _b = localStorage.getItem('bestillingsliste_v4');
      if (_b) {
        var _o = JSON.parse(_b);
        delete _o.tasks; delete _o.SECTIONS_DATA;
        delete _o.undersecOpen; delete _o.sectionOpen; delete _o.undersecBudget;
        localStorage.setItem('bestillingsliste_v4', JSON.stringify(_o));
      }
    } catch(e) {}
    try { localStorage.removeItem('bl_budget'); } catch(e) {}
